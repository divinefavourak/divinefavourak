...
import { DRIVES } from "./filesystem.jsx";
  ...
  return (
    <div className="nb-desktop">
      ...
      <aside className="nb-desktop-icons" aria-label="Desktop shortcuts">
        ...
        <DriveIcon icon="📄" label="RESUME.PDF" href={profile.resumeUrl} accent="pink" />
        <DriveIcon icon="🚪" label="EXIT.EXE" sub="back to the site" to="/" accent="yellow" />
      </aside>
